...
var App = (function () {
    function App(canvas, draftWidth) {
        if (draftWidth === void 0) { draftWidth = 750; }
    ...
    App.prototype.showScene = function () {
        //new Scene1(this);
        new Scene2(this);
    };
    ...
    App.prototype.loadAssets = function () {
        ...
        this.preLoader.addEventListener('progress', function (event) {
            progressBar.progress = event.progress;
        });
        this.preLoader.addEventListener('complete', function (e) {
            _this.preLoader.removeAllEventListeners();
    ...
    App.prototype.initStage = function (canvas, draftWidth) {
        ...
        var stageScale = w / draftWidth; //宽度自适应；
