class Preloader {
    ...
    onPreLoadComplete() {
        let s = this.sprite;
        let b = new createjs.Bitmap(this.preLoader.getResult("preloader back"));
        s.addChild(b);
        this.sprites.push(b);
        b = new createjs.Bitmap(this.preLoader.getResult("preloader progress back"));
        s.addChild(b);
        b.regX = b.getBounds().width / 2;
        b.regY = b.getBounds().height / 2;
        this.sprites.push(b);
        b = new createjs.Bitmap(this.preLoader.getResult("preloader progress top"));
        s.addChild(b);
        b.regX = b.getBounds().width / 2;
        b.regY = b.getBounds().height / 2;
        this.barRect = b.getBounds().clone();
        this.sprites.push(b);
        b = new createjs.Bitmap(this.preLoader.getResult("preloader candy"));
        s.addChild(b);
        b.regX = b.getBounds().width / 2;
        b.regY = b.getBounds().height / 2;
        this.sprites.push(b);
        b = new createjs.Bitmap(this.preLoader.getResult("preloader candy top"));
        s.addChild(b);
        b.regX = b.getBounds().width / 2;
...
//# sourceMappingURL=/page/sound/Preloader.js.map
