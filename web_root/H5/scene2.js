...
class Scene2 extends Scene {
    ...
    showCastleWhite() {
        ...
        let hole = Util.addImage(this.castleContainer, this.app.preLoader.getResult('castle-white-hole'), 1, { x, y, regX: x, regY: y });
        Util.addImage(this.castleContainer, this.app.preLoader.getResult('castle-white'), 2, { x: 100, y: 200 });
